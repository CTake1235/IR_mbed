...
int TransmitterIR::setData(RemoteIR::Format format, uint8_t *buf, int bitlength) {
    ...
    switch (format) {
        case RemoteIR::NEC:
            ...
            ticker.attach(Callback<void()>(this, &TransmitterIR::tick),RemoteIR::TUS_NEC * 1us);
            break;
        case RemoteIR::AEHA:
            ticker.detach();
            // ticker.attach_us(this, &TransmitterIR::tick, RemoteIR::TUS_AEHA);
            ticker.attach(Callback<void()>(this, &TransmitterIR::tick),RemoteIR::TUS_AEHA * 1us);
            break;
        case RemoteIR::SONY:
            ticker.detach();
            // ticker.attach_us(this, &TransmitterIR::tick, RemoteIR::TUS_SONY);
            ticker.attach(Callback<void()>(this, &TransmitterIR::tick),RemoteIR::TUS_SONY * 1us);
            break;
    }
